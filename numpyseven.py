#reshaping - means changing the shape of array , like adding or removing the elements.
...
# there are a lot of functions for the shapes pf of an array in numpy.
